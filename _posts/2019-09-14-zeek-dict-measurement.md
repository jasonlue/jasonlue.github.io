...
download pcap files from git-lfs
    `git lfs fetch`
...
![dict_stats.png](/img/dict_stats.png)
...
As the time measured varies greatly, the criteria I used is to keep increasing the rounds until the numbers stablize. Then use that rounds as the final measuring round.

```
cd ~/zeek.test/zeek
./zeek.stats -! ../key/Connection.147695.key@1:100000
./zeek.stats -! ../key/Connection.147695.key@10:10000
./zeek.stats -! ../key/Connection.147695.key@100:100000
./zeek.stats -! ../key/Connection.147695.key@1000:200000
./zeek.stats -! ../key/Connection.147695.key@10000:4000000
./zeek.stats -! ../key/Connection.147695.key@100000:6000000
```
...
- The speed improvement is visible in smaller tables < 1K. Improvements over larger tables is less. Because 99.96% dictionaries in zeek have size of 7 or less, clustered hashing improves the overall dictionary speed probably by 30% or more.
